...
public class ControlFrontal : MonoBehaviour
{
    ...
    public TMP_InputField[] entradasF = new TMP_InputField [12];
    ...
    void PonerEnInput(int a, int b){
        ...
        {
            case 0:
            entradasF[0].SetTextWithoutNotify(textoObjeto(objeto));
            break;

            case 1:
            entradasF[1].SetTextWithoutNotify(textoObjeto(objeto));
            break;

            case 2:
            entradasF[2].SetTextWithoutNotify(textoObjeto(objeto));
            break;

            case 3:
            entradasF[3].SetTextWithoutNotify(textoObjeto(objeto));
            break;

            case 4:
            entradasF[4].SetTextWithoutNotify(textoObjeto(objeto));
            break;

            case 5:
            entradasF[5].SetTextWithoutNotify(textoObjeto(objeto));
            break;

            case 6:
            entradasF[6].SetTextWithoutNotify(textoObjeto(objeto));
            break;

            case 7:
            entradasF[7].SetTextWithoutNotify(textoObjeto(objeto));
            break;

            case 8:
            entradasF[8].SetTextWithoutNotify(textoObjeto(objeto));
            break;

            case 9:
            entradasF[9].SetTextWithoutNotify(textoObjeto(objeto));
            break;

            case 10:
            entradasF[10].SetTextWithoutNotify(textoObjeto(objeto));
            break;

            case 11:
            entradasF[11].SetTextWithoutNotify(textoObjeto(objeto));
            break;
    ...
    public void CargarImagenBoton(){
        ...
        for (int i = 0; i < entradasF.Length; i++)
        {
            int loop = 0;
            foreach (string item in nombresObjetos)
            {
                if(entradasF[i].text == item){
